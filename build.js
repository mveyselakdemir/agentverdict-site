        ...
        <footer class="border-t border-slate-200 mt-16">
          <div class="max-w-5xl mx-auto px-4 py-8 text-sm text-slate-500 flex flex-col gap-2">
              <p>© ${new Date().getFullYear()} ${SITE_NAME}. Independent reviews — we may earn a commission from some links, which does not affect our ratings.</p>
                  <p><a href="/about.html" class="underline">About &amp; methodology</a> · <a href="/disclosure.html" class="underline">Affiliate disclosure</a> · <a href="/privacy-policy.html" class="underline">Privacy policy</a></p>
                    </div>
                    </footer>`;
}
...
function buildPrivacyPolicy() {
        ...
        <article class="max-w-2xl mx-auto px-4 py-12 prose">
          <h1 class="text-3xl font-bold mb-4">Privacy Policy</h1>
            <p class="text-slate-700 leading-relaxed mb-4">This Privacy Policy explains how ${SITE_NAME} ("we", "us") collects and uses information when you visit ${SITE_URL}.</p>
              <h2 class="text-xl font-semibold mt-6 mb-2">Cookies and advertising</h2>
                <p class="text-slate-700 leading-relaxed mb-4">We use third-party advertising companies, including Google, to serve ads when you visit this site. These companies may use cookies and similar technologies to collect information about your visits to this and other websites in order to provide advertisements about goods and services of interest to you. Google's use of advertising cookies enables it and its partners to serve ads based on your visit to this site and/or other sites on the Internet.</p>
                  <p class="text-slate-700 leading-relaxed mb-4">You may opt out of personalized advertising by visiting <a href="https://adssettings.google.com" class="underline" target="_blank" rel="noopener">Google Ads Settings</a>. Alternatively, you can opt out of some third-party vendors' use of cookies for personalized advertising by visiting <a href="https://www.aboutads.info" class="underline" target="_blank" rel="noopener">www.aboutads.info</a>.</p>
                    <h2 class="text-xl font-semibold mt-6 mb-2">Analytics</h2>
                      <p class="text-slate-700 leading-relaxed mb-4">We may use analytics tools to understand how visitors use this site in aggregate, anonymized form.</p>
                        <h2 class="text-xl font-semibold mt-6 mb-2">Data controller</h2>
                          <p class="text-slate-700 leading-relaxed mb-4">This site is independently operated. For any questions about this policy, you can reach out via the contact information on our About page.</p>
                            <h2 class="text-xl font-semibold mt-6 mb-2">Changes to this policy</h2>
                              <p class="text-slate-700 leading-relaxed mb-4">We may update this Privacy Policy from time to time. Changes will be posted on this page.</p>
                              </article>`;
        return layout({ title: `Privacy Policy — ${SITE_NAME}`, description: "Privacy policy for AgentVerdict.", canonical: `${SITE_URL}/privacy-policy.html`, body });
}
...
function build() {
  ...
  fs.writeFileSync(path.join(DIST, "index.html"), buildHome());
        ...
        fs.writeFileSync(path.join(DIST, "privacy-policy.html"), buildPrivacyPolicy());
  ...
  // ads.txt (required by AdSense)
  fs.writeFileSync(
            path.join(DIST, "ads.txt"),
            `google.com, pub-6874412047012645, DIRECT, f08c47fec0942fa0\n`
          );
}
